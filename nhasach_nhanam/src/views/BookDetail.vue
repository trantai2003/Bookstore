                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="current-menu-item"><a
                                                                href="productdetail.html">Product Detail</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="tg-featureditmcontent">
                                                        ...
                                                        <div class="tg-booktitle">
                                                            <h3><a href="javascript:void(0);">Things To Know About Green
                                                                    Flat Design</a></h3>
                                                        </div>
                                                        <span class="tg-bookwriter">By: <a
                                                                href="javascript:void(0);">Farrah Whisenhunt</a></span>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                <div class="tg-postbook">
                                                    <figure class="tg-featureimg"><img src="/images/books/img-07.jpg"
                                                            alt="image description"></figure>
                                                ...
                                                <div class="tg-productcontent">
                                                    ...
                                                    <div class="tg-description">
                                                        <p>Consectetur adipisicing elit, sed do eiusmod tempor
                                                            incididunt ut labore etdoloreat magna aliqua. Ut enim ad
                                                            minim veniam, quis nostrud exercitation ullamco laborisi
                                                            nisi ut aliquip ex ea commodo consequat aute.</p>
                                                        <p>Arure dolor in reprehenderit in voluptate velit esse cillum
                                                            dolore fugiat nulla aetur excepteur sint occaecat cupidatat
                                                            non proident, sunt in culpa quistan officia serunt mollit
                                                            anim id est laborum sed ut perspiciatis unde omnis iste
                                                            natus... <a href="javascript:void(0);">More</a></p>
                                                    </div>
                                                    ...
                                                    <ul class="tg-productinfo">
                                                        ...
                                                        <li><span>Publication Date:</span><span>June 27, 2017</span>
                                                        </li>
                                                        ...
                                                        <div role="tabpanel" class="tg-tab-pane tab-pane active"
                                                            ...
                                                            <div class="tg-description">
                                                                <p>Consectetur adipisicing elit, sed do eiusmod tempor
                                                                    ...
                                                                    ad minim veni quis nostrud exercitation ullamco
                                                                    laboris nisi ut aliquip ex ea commodo consequat.
                                                                    Duis aute irure dolor in reprehenden
                                                                    voluptate velit esse cillum dolore eu fugiat nulla
                                                                    pariatur.</p>
                                                                <figure class="tg-alignleft">
                                                                    <img src="/images/placeholdervtwo.jpg"
                                                                        alt="image description">
                                                                    <iframe
                                                                        src="https://www.youtube.com/embed/aLwpuDpZm1k?rel=0&amp;controls=0&amp;showinfo=0"></iframe>
                                                                </figure>
                                                                <ul class="tg-liststyle">
                                                                    <li><span>Sed do eiusmod tempor incididunt ut labore
                                                                            et dolore</span></li>
                                                                    <li><span>Magna aliqua enim ad minim veniam</span>
                                                                    </li>
                                                                    <li><span>Quis nostrud exercitation ullamco laboris
                                                                            nisi ut</span></li>
                                                                    <li><span>Aliquip ex ea commodo consequat aute dolor
                                                                            reprehenderit</span></li>
                                                                    <li><span>Voluptate velit esse cillum dolore eu
                                                                ...
                                                                <p>Sed ut perspiciatis unde omnis iste natus error sit
                                                                    ...
                                                                    remmata aperiam, eaque ipsa quae ab illo inventore
                                                                    veritatis et quasi architecto beatae vitae dicta
                                                                    sunt explicabo. Nemo enimsam
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="tg-authorbox">
                                                        <figure class="tg-authorimg">
                                                            <img src="/images/author/imag-24.jpg"
                                                                alt="image description">
                                                        </figure>
...
//ref là 1 cái gói để chứa dữ liệu của 1 loại dữ liệu nào đó
const book = ref(null as Book | null);
onMounted(() => {
    const bookId = router.currentRoute.value.params.id as string;
    // book.value = Book 
    book.value = book_service.getById(bookId);
});
</script>
